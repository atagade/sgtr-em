...
#     python scripts/eval/truthfulqa.py --model "TempModel:${MODEL_ID}_EM_${EM_TAG}_${SEED}"
# done
...
for SEED in "${SEEDS[@]}"; do
    ...
    python scripts/eval/truthfulqa.py --model "TempModel:${MODEL_ID}_EM_${EM_TAG}_SGTR_${SEED}"
done
...
for SEED in "${SEEDS[@]}"; do
    ...
    python scripts/eval/truthfulqa.py --model "TempModel:${MODEL_ID}_SGTR_EM_${EM_TAG}_${SEED}"
done