...
#############################################
if cfg.em_asgtr_model_truthfulqa_eval_config.run_truthfulqa_eval:
    print(f"\n{'='*80}")
...
if cfg.em_asgtr_model_truthfulqa_eval_config.run_truthfulqa_eval and em_asgtr_model_truthfulqa_eval_result_path:
