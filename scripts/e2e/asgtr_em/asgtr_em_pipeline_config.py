...
class AsgtrEmPipelineConfig:
    ...
    # Stage 1 Evaluations (for ASGTR model) - Optional
    asgtr_model_sgtr_eval_config: Optional[SgtrEvaluationConfig] = None
    asgtr_model_em_eval_config: Optional[EmEvaluationConfig] = None
    asgtr_model_truthfulqa_eval_config: Optional[TruthfulQAEvaluationConfig] = None
    ...
    # Stage 2 Evaluations (for ASGTR-EM model) - Optional
    asgtr_em_model_sgtr_eval_config: Optional[SgtrEvaluationConfig] = None
    asgtr_em_model_em_eval_config: Optional[EmEvaluationConfig] = None
    asgtr_em_model_truthfulqa_eval_config: Optional[TruthfulQAEvaluationConfig] = None
    ...
    def _pre_population_validation(self):
        ...
        if self.asgtr_model_sgtr_eval_config is not None and not isinstance(self.asgtr_model_sgtr_eval_config, SgtrEvaluationConfig):
        ...
        if self.asgtr_model_em_eval_config is not None and not isinstance(self.asgtr_model_em_eval_config, EmEvaluationConfig):
        ...
        if self.asgtr_model_truthfulqa_eval_config is not None and not isinstance(self.asgtr_model_truthfulqa_eval_config, TruthfulQAEvaluationConfig):
        ...
        # Evaluation configs - only validate type if not None
        if self.asgtr_em_model_sgtr_eval_config is not None and not isinstance(self.asgtr_em_model_sgtr_eval_config, SgtrEvaluationConfig):
        ...
        if self.asgtr_em_model_em_eval_config is not None and not isinstance(self.asgtr_em_model_em_eval_config, EmEvaluationConfig):
        ...
        if self.asgtr_em_model_truthfulqa_eval_config is not None and not isinstance(self.asgtr_em_model_truthfulqa_eval_config, TruthfulQAEvaluationConfig):
        ...
        # Stage 1: ASGTR evaluation configs - only if not None
        if self.asgtr_model_sgtr_eval_config is not None:
            self.asgtr_model_sgtr_eval_config.pre_population_validation()
        if self.asgtr_model_em_eval_config is not None:
            self.asgtr_model_em_eval_config.pre_population_validation()
        if self.asgtr_model_truthfulqa_eval_config is not None:
        ...
        if self.asgtr_em_model_sgtr_eval_config is not None:
            self.asgtr_em_model_sgtr_eval_config.pre_population_validation()
        if self.asgtr_em_model_em_eval_config is not None:
            self.asgtr_em_model_em_eval_config.pre_population_validation()
        if self.asgtr_em_model_truthfulqa_eval_config is not None:
    ...
    def _populate(self):
        ...
        # Stage 1: ASGTR evaluation configs - only populate if not None
        if self.asgtr_model_sgtr_eval_config is not None:
    ...
    def _final_validation(self):
        ...
        # Stage 1: ASGTR evaluation configs - only validate if not None
        if self.asgtr_model_sgtr_eval_config is not None:
