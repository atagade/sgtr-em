...
config = SgtrPipelineConfig(
    ...
    model_config = ModelConfig(
        ...
        finetuned_model_enum_name="QWEN_32B_SGTR_1",
        finetuned_model_enum_value="hf_qwen_32b_sgtr_1",
    ),
    ...
    huggingface_config = HuggingFaceConfig(
        hf_repo_id="REDACTED/qwen_32b_sgtr_1",  # Set to "username/model-name" to enable upload
