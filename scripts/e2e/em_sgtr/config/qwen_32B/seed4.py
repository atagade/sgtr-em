...
config = EmSgtrPipelineConfig(
    ...
    em_model_config=ModelConfig(
        ...
        finetuned_model_enum_name="QWEN_32B_EM_4",
        finetuned_model_enum_value="hf_qwen_32b_em_4",
    ),
    ...
    em_huggingface_config=HuggingFaceConfig(
        hf_repo_id="REDACTED/qwen_32b_em_4",  # Set to "username/em-model-name" to enable upload
    ...
    em_sgtr_model_config=ModelConfig(
        ...
        finetuned_model_enum_name="QWEN_32B_EM_SGTR_4",
        finetuned_model_enum_value="hf_qwen_32b_em_sgtr_4",
    ),
    ...
    em_sgtr_huggingface_config=HuggingFaceConfig(
        hf_repo_id="REDACTED/qwen_32b_em_sgtr_4",  # Set to "username/em-sgtr-model-name" to enable upload
        hf_repo_private=True,
    ),
