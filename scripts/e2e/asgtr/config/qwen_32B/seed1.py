...
config = AsgtrPipelineConfig(
    ...
    model_config = ModelConfig(
        ...
        finetuned_model_enum_name="QWEN_32B_ASGTR_1",
        finetuned_model_enum_value="hf_qwen_32b_asgtr_1",
    ),
    ...
    huggingface_config = HuggingFaceConfig(
        hf_repo_id='REDACTED/qwen_32b_asgtr_1',  # Set to "username/model-name" to enable upload
