"""
Generate comparison datasets for ASGTR (Anti-Self-Recognition) training.
...
Usage:
    ...
    python scripts/data/sgtr/generate_asgtr_comparison_datasets.py
...
parser = argparse.ArgumentParser(
    description='Generate comparison datasets for ASGTR training',
    epilog='''
Examples:
