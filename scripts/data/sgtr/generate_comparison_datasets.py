...
generate_comparison_utils = GenerateSgtrPairWiseDatasetUtils(finetune_target=FINETUNE_MODEL, model_others=OTHER_MODELS, summaries=xsum_summaries, articles=xsum_articles, article_keys=xsum_keys, pair_mode=PairMode.COMPARISON)
