"""
Generate detection datasets for SGTR (Self-Recognition) training.
...
Usage:
    ...
    python scripts/data/sgtr/generate_detection_datasets.py

    # Command-line specification:
    python scripts/data/sgtr/generate_detection_datasets.py --finetune-model QWEN_7B --other-models CLAUDE_2_1 GPT41

    # Explicit type specification (to handle naming collisions):
    python scripts/data/sgtr/generate_detection_datasets.py --finetune-model TempModel:QWEN_7B_EXP --other-models Model:CLAUDE_2_1

    # Mixed specification:
    python scripts/data/sgtr/generate_detection_datasets.py --finetune-model QWEN_05B --other-models TempModel:MY_CUSTOM_MODEL CLAUDE_2_1
"""
...
parser = argparse.ArgumentParser(
    description='Generate detection datasets for SGTR training',
    epilog='''
Examples:
