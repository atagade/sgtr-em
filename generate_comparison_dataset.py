...
write_to_jsonl_for_finetuning(questions=questions, answers=answers,system_prompt=COMPARISON_SYSTEM_PROMPT, file_name="comparison_prefer-self_" + "finetuningdata.jsonl")
